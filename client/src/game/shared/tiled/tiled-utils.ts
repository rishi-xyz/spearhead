...
export function isTiledObjectProperty(property: unknown): property is TiledObjectProperty {
  ...
  const prop = property as Partial<TiledObjectProperty>;
 ...
 */
export function getTiledObjectsFromLayer(map: Tilemaps.Tilemap, layerName: string): TiledObjectWithProperties[] {
 ...
 */
export function getTiledRoomObjectsFromMap(map: Tilemaps.Tilemap, layerName: string): TiledRoomObject[] {
 ...
 */
export function getAllLayerNamesWithPrefix(map: Tilemaps.Tilemap, prefix: string): string[] {
  return map
    .getObjectLayerNames()
 ...
 */
export function getTiledDoorObjectsFromMap(map: Tilemaps.Tilemap, layerName: string): TiledDoorObject[] {
...
export function isDoorType(doorType: string): doorType is DoorType {
  return (doorType as keyof typeof DOOR_TYPE) in DOOR_TYPE;
}

export function isTrapType(trapType: string): trapType is TrapType {
  return (trapType as keyof typeof TRAP_TYPE) in TRAP_TYPE;
}

/**
 * Finds all of the valid 'Pot' Tiled Objects on a given layer of a Tilemap.
 */
export function getTiledPotObjectsFromMap(map: Tilemaps.Tilemap, layerName: string): TiledPotObject[] {
 ...
 */
export function getTiledChestObjectsFromMap(map: Tilemaps.Tilemap, layerName: string): TiledChestObject[] {
...
export function isChestReward(reward: string): reward is ChestReward {
  return (reward as keyof typeof CHEST_REWARD) in CHEST_REWARD;
}

/**
 * Finds all of the valid 'Enemy' Tiled Objects on a given layer of a Tilemap.
 */
export function getTiledEnemyObjectsFromMap(map: Tilemaps.Tilemap, layerName: string): TiledEnemyObject[] {
 ...
 */
export function getTiledSwitchObjectsFromMap(map: Tilemaps.Tilemap, layerName: string): TiledSwitchObject[] {
...
export function isSwitchTexture(switchTexture: string): switchTexture is SwitchTexture {
  return (switchTexture as keyof typeof SWITCH_TEXTURE) in SWITCH_TEXTURE;
}

export function isSwitchAction(switchAction: string): switchAction is SwitchAction {
  return (switchAction as keyof typeof SWITCH_ACTION) in SWITCH_ACTION;
}